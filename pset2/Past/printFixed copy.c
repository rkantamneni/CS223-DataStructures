...
//Calculate no. of digits in input
...
//**Creates Array and give size**
    ...
    long long numArray[arraySize];
    long long count2 = inputLength; 
    ...
    if (count2 != 0) {
        ...
        while (arrayBigNum != 0) {
            ...
            if (isNegative == 1){
                ...
                numArray[count2] = (arrayBigNum % 10);
            }
            //Version 3
            //numArray[count2] = abs(arrayBigNum % 10); //replaces entire if else statement

...
void dictGrow(DictStringInt d){
    ...
    d2 = dictStringIntCreateInternal(d->size * SIZE_MULTIPLIER);
...
char *connectSalt(char *s1, char *s2 ,length) { //Online
...
int main(int argc, char **argv) {
    ...
    DictStringInt d = DictStringInt(INITIAL_SIZE);
